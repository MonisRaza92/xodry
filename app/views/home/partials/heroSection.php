    ...
    <div class="container px-lg-0">
        <div class="row mb-4">
            <div class="hero-content col-lg-5">
                <h1 class="heading mt-2" data-aos="fade-up">Freshnes <span>Deliverd</span> to Your Door</h1>
                ...
                <button data-aos="fade-up" onclick="window.location.href='pricing'">Pricing</button>

            </div>
            <div class="hero-img col-lg-7 px-3" data-aos="fade-up">
