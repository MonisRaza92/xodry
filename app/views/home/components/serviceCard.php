<?php foreach ($categoriesForCard as $cat): ?>
    <div class="col-lg-4 col-md-6 mb-4" data-aos="fade-up">
        <div class="xodry-whatwedo-card p-0 h-100">
            ...
            <div class="service-card-content p-4">
                ...
                <a class="btn text-dark w-100 rounded-1 mt-4" style="background: var(--contrast-color);" href="pricing">See Prices &nbsp; <i class="fa-solid fa-arrow-right"></i></a>
            </div>
        </div>
    </div>
<?php endforeach; ?>